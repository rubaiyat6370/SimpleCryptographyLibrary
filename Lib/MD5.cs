...
namespace Lib
{
    public class MD5
    {
        public string Hash(string plainText)
        {
            ...
            String bitStringForPlainText = StringToBitString(plainText);
        ...
        public static String[] InitialVariableForMd5()
        {
            String[] initial =
			{
        ...
        public static String StringToBitString(String inputString)
        {
            ...
            foreach (char c in inputString)
            {
                ...
                {
                    quotient = ascii / 2;
                    remainder += (ascii % 2).ToString(CultureInfo.InvariantCulture);
                    ascii = quotient;
                }
        ...
        public static String IntToBinary(int number)
        {
            ...
            {
                quotient = number / 2;
                remainder += (number % 2).ToString(CultureInfo.InvariantCulture);
                number = quotient;
            }
        ...
        {
            var words = new String[inputString.Length / 32];
        ...
        public static string MainLoop(String[] m)
        {
