...
namespace CRC
{
    class Program
    {
        public static void Main()
        {
            var input = "A";
            var l = 4;
            Console.WriteLine(CRC(input, l)) ;
            Console.ReadKey();
        }

        public static string CRC(string input, int crcLength)
        {
        ...
        private static IEnumerable<char> GetValue(string polynomial, string text)
        {
        ...
        private static String PolynomialToBinary(string polynomial)
        {
